$(document).ready(function () {
    ...
    $('.plus').on('click',function() {
      ...
      $(this).next().css('z-index', '102');
      $(this).css({ transform: 'rotate('+45+'deg)'});
      $(this).css('background-color', '#fa6756');
    ...
    $(function() {
        ...
        //Popup block5
        $('#bl5-img1').on('click', function(){
          $('#bl5popup-img1').css('opacity', '1');
          $('#bl5popup-img1').css('z-index', '2');
        });
        $('#bl5-img2').on('click', function(){
          $('#bl5popup-img2').css('opacity', '1');
          $('#bl5popup-img2').css('z-index', '2');
        }); 
        $('#bl5-img3').on('click', function(){
          $('#bl5popup-img3').css('opacity', '1');
          $('#bl5popup-img3').css('z-index', '2');
        });
        $('#bl5-img4').on('click', function(){
          $('#bl5popup-img4').css('opacity', '1');
          $('#bl5popup-img4').css('z-index', '2');
        });                
        $('#bl5-img5').on('click', function(){
          $('#bl5popup-img5').css('opacity', '1');
          $('#bl5popup-img5').css('z-index', '2');
        });
        $('#bl5-img6').on('click', function(){
          $('#bl5popup-img6').css('opacity', '1');
          $('#bl5popup-img6').css('z-index', '2');
        }); 
        $('#bl5-img7').on('click', function(){
          $('#bl5popup-img7').css('opacity', '1');
          $('#bl5popup-img7').css('z-index', '2');
        });
        $('#bl5-img8').on('click', function(){
          $('#bl5popup-img8').css('opacity', '1');
          $('#bl5popup-img8').css('z-index', '2');
        }); 
        $('#bl5-img9').on('click', function(){
          $('#bl5popup-img9').css('opacity', '1');
          $('#bl5popup-img9').css('z-index', '2');
        });
